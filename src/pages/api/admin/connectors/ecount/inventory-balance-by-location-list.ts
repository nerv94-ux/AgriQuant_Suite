...
import { callEcountGetListInventoryBalanceStatusByLocation } from "@/components/common/api/server/connectors/ecount";
...
export default async function handler(
  ...
  const result = await callEcountGetListInventoryBalanceStatusByLocation({
    requestId,
    timeoutMs: 10_000,
    appId: "admin-inventory-balance-by-location-list",
